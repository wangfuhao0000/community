...
import cug.wangfh.community.service.DiscussPostService;
...
public class HomeController implements CommunityConstant {
    ...
    public String getIndexPage(Model model, Page page,
        ...
        // SpringMVC会自动实力话Model和Page，将Page注入Model
        ...
        if (list != null) {
            for (DiscussPost post : list) {
                ...
                long likeCount = likeService.findEntityLkeCount(ENTITY_TYPE_POST, post.getId());
